...
- `../Sales Toolkit/auto email/` — the Streamax cold-email agent. Shares the same `streamax-knowledge` skill in its `.Codex/skills/` directory (where to look up product specs, SafeGPT mechanics, value-propositions when authoring sections).
