...
<head>
    ...
    <!-- Only what the portal actually uses: fonts + Font Awesome icons.
         (Tailwind/lucide/three/GSAP CDNs removed — nothing referenced them;
         the morph iframe loads its own three.js with China-friendly fallbacks.) -->
