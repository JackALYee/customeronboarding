...
<div id="support" class="content-section hidden">
    ...
    <div class="card fade-up">
        <details style="border-bottom: 1px solid var(--line); padding: 14px 0; cursor: pointer;">
    ...
    <div class="grid-3 fade-up">
        <div class="glass-panel">
            <h4><i class="fa-brands fa-apple" aria-hidden="true" style="color: var(--text-white);"></i> <i class="fa-brands fa-android" aria-hidden="true" style="color: var(--gold);"></i> FT Cloud mobile app (iOS &amp; Android)</h4>
    ...
    <div class="card fade-up" style="background: linear-gradient(135deg, rgba(160,192,0,0.06), rgba(0,112,192,0.03));">
